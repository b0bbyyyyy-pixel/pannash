      ...
      <table className="w-full min-w-[1000px]">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            ...
            <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[130px]">
              Phone
            </th>
            <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[150px]">
              Company
            ...
            >
              ...
              <td className="px-6 py-4 text-sm text-gray-600 max-w-sm">
                {editingCell?.leadId === lead.id && editingCell?.field === 'email' ? (
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      title={lead.email || 'Click to edit'}
                    >
                      {lead.email || '—'}
                    </span>
                ...
                {lead.email_validation_notes && !editingCell && (
                  <div className="text-xs text-gray-500 mt-1 max-w-xs truncate" title={lead.email_validation_notes}>
