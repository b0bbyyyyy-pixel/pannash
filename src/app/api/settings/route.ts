  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .upsert({
        ...
        sms_daily_limit: body.sms_daily_limit,
        sms_frequency: body.sms_frequency,
        ...
        ai_response_delay_min: body.ai_response_delay_min,
        ai_response_delay_max: body.ai_response_delay_max,
