  ...
  return (
    <div>
      ...
      <div className="bg-white border border-[#e5e5e5] rounded-lg overflow-hidden">
        {/* Table header */}
        <div className={`grid ${PIPELINE_COLS} gap-x-2 border-b border-[#e5e5e5] bg-[#fafafa] px-3 py-2`}>
          ...
          <div className="text-[10px] font-bold text-[#9b9b9b] uppercase tracking-wider text-right">Amount</div>
          <div className="text-[10px] font-bold text-[#9b9b9b] uppercase tracking-wider whitespace-nowrap">Follow-up</div>
