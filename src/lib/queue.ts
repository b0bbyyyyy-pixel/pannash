 ...
 * @param frequencyRange - String like "5-10" (minutes) or "0.5-2"
 * @returns Delay in seconds
 */
export function getRandomDelay(frequencyRange: string = '5-10'): number {
 ...
 * @param frequencyRange - Minutes between emails (e.g., "5-10", "10-20") - RECOMMENDED: "5-10"
 * @returns Array of ISO timestamp strings
 */
export function generateScheduledTimes(
  count: number, 
  startTime?: Date,
  frequencyRange: string = '5-10'
): string[] {
  const times: string[] = [];
